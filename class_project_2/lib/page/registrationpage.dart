            ...
            Center(
              child: ElevatedButton(
                onPressed: (){
                  ...
                  String cellNo=cell.text;
                  String addr=address.text;
                  String dateob=dob.text;
                  String gen=selectedGender.toString();
                  print('Email:$em, Password:$pass, Confirm Password:$conPass, Cell No:$cellNo, Address:$addr, Date of Birth:$dateob, Gender:$gen');
                },
